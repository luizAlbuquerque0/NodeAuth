/*
  ...
  - Added the required column `experisAt` to the `refresh_tokens` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "experisAt" TIMESTAMP(3) NOT NULL,
